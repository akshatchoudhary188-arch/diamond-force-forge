...
function SponsorsPage() {
  ...
  return (
    <PageShell>
      <div className="snap-y snap-mandatory overflow-y-auto scroll-smooth" style={{ height: "100vh" }}>
        {/* Featured Sponsor — Full Page */}
        <section className="relative flex min-h-screen snap-start flex-col items-center justify-center bg-[#0b0b0b] px-6 py-28 text-center">
          <div className="reveal mx-auto max-w-4xl">
            ...
            >
              <div className="mx-auto flex h-64 w-64 items-center justify-center rounded-sm border border-[#d4af37]/30 bg-black p-8 transition-all hover:border-[#d4af37] hover:shadow-[0_0_80px_rgba(212,175,55,0.12)] sm:h-80 sm:w-80">
                <img
                  src={featured.image}
                  alt={featured.name}
          ...
          <div className="absolute bottom-8 left-1/2 flex -translate-x-1/2 flex-col items-center gap-2">
            <span className="text-[10px] uppercase tracking-[0.2em] text-[#f5f5f5]/40">Scroll to see more</span>
            <ChevronDown className="h-5 w-5 animate-bounce text-[#d4af37]" />
          </div>
        </section>

        {/* Other Sponsors — Full Page */}
        <section className="relative flex min-h-screen snap-start flex-col items-center justify-center bg-[#0b0b0b] px-4 py-28 sm:px-6">
        ...
        {/* Why Sponsor Us */}
        <section className="relative min-h-screen snap-start bg-[#0b0b0b] px-4 py-28 sm:px-6">
          <div className="mx-auto max-w-6xl">
            <PageHero
              eyebrow="Partnership"
              title={<>Why <span className="gold-gradient">Sponsor</span> Us</>}
              subtitle="Partner with a team that turns engineering passion into podium results."
            />
        ...
        {/* Become a Sponsor */}
        <section className="relative flex min-h-screen snap-start items-center justify-center bg-[#0b0b0b] px-4 py-28 sm:px-6">
