...
function FindUs() {
  return (
    <section id="findus" className="relative bg-[#0f0f0f] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="reveal grid gap-8 lg:grid-cols-5">
          ...
          <div className="metallic-border rounded-md p-8 lg:col-span-2 flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-sm bg-[#d4af37] px-6 py-3 text-xs font-bold uppercase tracking-[0.25em] text-black transition hover:bg-[#f0cf5a]"
              >
