...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Black Diamond Robotics" },
      { property: "og:description", content: "Forging machines that refuse to lose. India's premier combat robotics team." },
