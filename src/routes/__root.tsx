...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Black Diamond Robotics" },
      { property: "og:title", content: "Black Diamond Robotics — Forging Machines That Refuse To Lose" },
      { property: "og:description", content: "Team Black Diamond Robotics — India's premier student combat robotics team. We design, build and battle world-class combat robots." },
