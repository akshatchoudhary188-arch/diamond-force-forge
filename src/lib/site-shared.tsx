...
export const BOTS = [
  {
    ...
    drive: "2WD brushless direct drive",
    materials: "EN28 weapon, aluminium 6061 chassis",
    ...
    specs: [
      "Aluminium 6061 chassis for durability and stability during intense battles.",
  ...
  },
  {
    ...
    drive: "2WD brushless direct drive",
    materials: "EN28 weapon, aluminium 6061 chassis",
    performance: "Fast, low-profile aggression with sustained spinner energy",
    history: ["AXIS VNIT — Winner (8 kg)", "BITS Quark — Winner"],
    desc: "A powerful 8 kg combat robot built for RoboWar competitions.",
    specs: [
      "Aluminium 6061 chassis for durability and stability during intense battles.",
      "High-impact vertical spinner weapon built from EN28 steel to damage and disable opponent robots.",
      "Fast brushless drive system with solid wheels for quick movement and excellent arena control.",
      "Low-profile design engineered for aggressive performance, durability, and high-impact combat power.",
    ],
    icon: Cog,
  ...
  },
  {
    ...
    specs: [
      "Aluminium 6061 chassis designed to absorb heavy impacts while maintaining structural strength during intense battles.",
      "High-speed drum spinner weapon built from EN28 steel, capable of delivering devastating upward strikes to flip, damage, and destabilize opponent robots.",
  ...
  },
  {
    ...
    specs: [
      "Aluminium 6061 chassis designed to handle heavy impacts in the arena.",
      "High-speed drum spinner weapon built from EN28 steel, delivering powerful strikes to damage and disable opponent robots.",
      "Strong brushless 2WD drive system for excellent stability, fast movement, and precise control.",
      "Curvy body engineered for durability and competitive performance in RoboWar events.",
    ],
    icon: Cpu,
